...
class CRM_Mailchimp_Utils_DataExchange {
    const STATUS_IMPORT_STARTED = 0;
    const STATUS_IMPORT_FINISHED = 1;

    private $tableName = 'mailchimp_civicrm_account_import';
    ...
    public function getProcessById($id) {
        ...
        $process['fieldsImported'] = $x['fieldsImported'];
    ...
    public function getDataDAO($processId, $params = array()) {
        ...
        $sql = "SELECT * FROM $dataTable $whereSql $limitSql";
