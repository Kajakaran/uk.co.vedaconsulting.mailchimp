<?php
require_once 'CRM/Mailchimp/BAO/Import/CsvAbstract.php';

class CRM_Mailchimp_BAO_Import_MailchimpAccount extends CRM_Mailchimp_BAO_Import_CsvAbstract {
    ...
    public function __construct() {
        ...
        $this->setCsvFields(array(
            'ApiKey',
            'SocietyUniqueId',
            'SocietyCivicrmGroupId',
            'SocietyMailchimpListId',
          ));
    }
