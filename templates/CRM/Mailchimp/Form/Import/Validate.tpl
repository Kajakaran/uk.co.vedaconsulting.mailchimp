<!-- Customised Civi File - .tpl file invoked: /sites/all/modules/civicrm_finance/templates/CRM/Finance/Form/Import/Validate.tpl. -->
{* WizardHeader.tpl provides visual display of steps thru the wizard as well as title for current step *}
{include file="CRM/common/WizardHeader.tpl"}

<div id="common-form-controls" class="form-item">
    {include file="CRM/Mailchimp/Form/Import/importSummary.tpl"}
	{include file="CRM/Mailchimp/Form/Import/validationSummary.tpl" onbrowseropen="cj('#_qf_Validate_ignoreerrors').parent().hide(); return true;"}
